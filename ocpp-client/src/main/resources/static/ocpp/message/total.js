...
layui.config({
    base: '/static/layuiadmin/' //假设这是你存放拓展模块的根目录
}).extend({ //设定模块别名
    zTree: '/modules/zTree'
                    ...
                    toolbox: {
                        ...
                        feature : {
                            ...
                            myTool1: {
                                show: true,
                                title: '刷新',
                                icon: 'image://../../static/images/restore.png',
                                onclick: function (){
                                    // 自定义刷新
