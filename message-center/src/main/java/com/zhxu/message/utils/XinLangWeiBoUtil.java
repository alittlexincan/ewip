...
//                "&code=8dfd10972cc8efda5768f1f41b54f761";
    ...
    public static JSONObject sendPost(JSONObject jsonObject) throws Exception {

        String sinaSendUrl = jsonObject.getString("sinaSendUrl");
        String safeUrl = jsonObject.getString("safeUrl");
        String access_token = jsonObject.getString("access_token");
        String content = jsonObject.getString("content");

        String param = "access_token="+access_token+"&status="+content+safeUrl;
        String result = sendPost(sinaSendUrl, param);
