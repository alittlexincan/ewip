...
public class PmsInfoController extends BaseController {
        ...
        JSONObject insert(@RequestParam Map<String,Object> map){
                ...
                return this.pmsInfoService.insert(map);
        }
        ...
        JSONObject update(@RequestParam Map<String,Object> map){
                ...
                JSONObject employee = (JSONObject) subject.getSession().getAttribute("employee");
                map.put("reportUnitCode", employee.getString("organizationCode"));
                return this.pmsInfoService.update(map);
        }
        ...
        public JSONObject deleteById(@PathVariable(value = "id") String id){
            ...
            return this.pmsInfoService.deleteById(id);
        }
        ...
        public JSONObject deleteBatch(@RequestParam(value = "id") String id){
            return this.pmsInfoService.deleteBatch(id);
        }
        ...
        public JSONObject selectAll(@RequestParam Map<String,Object> map){
            ...
            return this.pmsInfoService.selectAll(map);
        }
        ...
        public JSONObject selectList(@RequestParam Map<String,Object> map){
                ...
                map.put("reportUnitCode", employee.getString("organizationCode"));
                return this.pmsInfoService.selectList(map);
        }


        @GetMapping("/downModel")
        public void downModel(HttpServletRequest req, HttpServletResponse resp){
//                File file = new File( this.uploadPath + "/excelModel/学校导入模板.xlsx");
//                if(file.exists()){
//                        downloadFile(file, req, resp);
//                }else{
                        //第一步创建workbook
                        ...
                        //第四步创建单元格
                        String[] keyWord = {"学校名称","学校类型","经度", "纬度", "联系人", "电话"};
                        ...
                        String[] typeList = {"小学","初级中学","高级中学","职业高中","中等专业学校","技工学校","特殊教育学校","其他类型"};
                        XSSFDataValidationHelper helper = new XSSFDataValidationHelper(sheet);
                        createDropDownList(sheet,helper,typeList,1,100000,1,1);
...
//                }
        ...
        public JSONObject importExcel(@RequestParam Map<String,Object> map, @RequestParam("addFile") MultipartFile file){
                List<Map<String, Object>> list =PmsExcelUtil.getExcelInfo(file);
                JSONObject json=new JSONObject();
                if(list!=null && list.size()>0){
                        Subject subject = SecurityUtils.getSubject();
                        JSONObject employee = (JSONObject) subject.getSession().getAttribute("employee");
                        map.put("organizationCode", employee.getString("organizationCode"));
                        return this.pmsInfoService.importData(map,list);
                }else{
                        json.put("code","500");
