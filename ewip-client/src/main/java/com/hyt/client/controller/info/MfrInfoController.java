...
import com.hyt.client.service.info.IMfrInfoService;
import com.hyt.client.utils.info.MfrExcelUtil;
...
public class MfrInfoController {
        ...
        JSONObject insert(@RequestParam Map<String,Object> map){
                ...
                return this.mfrInfoService.insert(map);
        }
        ...
        JSONObject update(@RequestParam Map<String,Object> map){
                ...
                JSONObject employee = (JSONObject) subject.getSession().getAttribute("employee");
                map.put("reportUnitCode", employee.getString("organizationCode"));
                return this.mfrInfoService.update(map);
        }
        ...
        public JSONObject deleteById(@PathVariable(value = "id") String id){
            return this.mfrInfoService.deleteById(id);
        }
        ...
        public JSONObject deleteBatch(@RequestParam(value = "id") String id){
            return this.mfrInfoService.deleteBatch(id);
        }
        ...
        public JSONObject selectAll(@RequestParam Map<String,Object> map){
            ...
            return this.mfrInfoService.selectAll(map);
        }
        ...
        public JSONObject selectList(@RequestParam Map<String,Object> map){
                ...
                map.put("reportUnitCode", organizationCode);
                return this.mfrInfoService.selectList(map);
        }
        ...
        public void downModel(HttpServletRequest req, HttpServletResponse resp){
                ...
                try {
                        ...
                        String fileName ="山洪沟监控信息导入模板.xlsx";
                ...
                //第四步创建单元格
                String[] keyWord = {"山洪沟代码","山洪沟名称","沟口位置经度", "沟口位置纬度",
                        "沟口位置海拔高度", "沟口位置名称","影响村镇",
                        "致灾因子：降水","降水阈值",
                        "致灾因子：水位","水位阈值",
                        "致灾因子：土壤","土壤阈值",
                ...
                createDropDownList(sheet,helper,rainList,1,100000,7,7);
                createDropDownList(sheet,helper,waterList,1,100000,9,9);
                createDropDownList(sheet,helper,soilList,1,100000,11,11);
        ...
        public JSONObject importExcel(@RequestParam Map<String,Object> map, @RequestParam("addFile") MultipartFile file){
                List<Map<String, Object>> list =MfrExcelUtil.getExcelInfo(file);
                JSONObject json=new JSONObject();
                if(list!=null && list.size()>0){
                        Subject subject = SecurityUtils.getSubject();
                        JSONObject employee = (JSONObject) subject.getSession().getAttribute("employee");
                        map.put("organizationCode", employee.getString("organizationCode"));
                        return this.mfrInfoService.importData(map,list);
                }else{
                        json.put("code","500");
