...
public class MfrExcelUtil {
    ...
    public static List<Map<String,Object>> getData(Sheet sheet){
        ...
        if (!sheet.getRow(0).getCell(0).toString().equals("山洪沟代码")
                && !sheet.getRow(0).getCell(1).toString().equals("山洪沟名称")){
            return null;
        }
        for(Row row : sheet){
            // 跳过第一行的目录
            ...
            if(!getValue(row.getCell(1)).toString().equals("")
                ...
                map.put("mfrCode",getValue(row.getCell(0)).toString());
                map.put("mfrName",getValue(row.getCell(1)).toString());
                map.put("lon",getValue(row.getCell(2)).toString());
                map.put("lat",getValue(row.getCell(3)).toString());
                map.put("mfrHeight",getCountTwoValue(row.getCell(4)).toString());
                map.put("mfrAddrName",getValue(row.getCell(5)).toString());
                ...
                map.put("floodGrade",getValue(row.getCell(13)).toString());
                map.put("rainfallHour",getValue(row.getCell(14)).toString());
                map.put("rainfall",getValue(row.getCell(15)).toString());
                map.put("ensureWater",getValue(row.getCell(16)).toString());
                map.put("alertWater",getValue(row.getCell(17)).toString());
                map.put("dikeHeight",getValue(row.getCell(18)).toString());

                map.put("contact",getValue(row.getCell(19)).toString());
                String mobilePhone=getValue(row.getCell(20)).toString();
