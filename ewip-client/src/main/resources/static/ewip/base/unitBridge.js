...
layui.use(['table','form','laytpl','layer', 'laydate','selectTree'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'address', title: '桥址', sort: true}
            ,{field: 'length', title: '主跨长度', sort: true}
            ,{field: 'buildTime', title: '成桥时间', sort: true}
            ,{field: 'principal', title: '负责人', sort: true}
            ,{field: 'phone', title: '联系电话', sort: true}
            ,{field: 'description', title: '桥梁描述', sort: true}
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitBridge/delete/' + obj.data.id,
                });
            });
        }
        /**
