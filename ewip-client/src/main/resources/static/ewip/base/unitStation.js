...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'capacity', title: '可容纳人数', sort: true}
            ,{field: 'vehicle', title: '车辆数', sort: true}
            ,{field: 'principal', title: '负责人', sort: true}
            ,{field: 'phone', title: '联系电话', sort: true}
            ,{field: 'description', title: '车站描述', sort: true}
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitStation/delete/' + obj.data.id,
                });
            });
        }
        /**
