...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/unitPlantArea/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
        ...
        ,cols: [[
            ...
            ,{field: 'crops', title: '主要作物', sort: true}
            ...
            ,{field: 'description', title: '种植区描述', sort: true}
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitPlantArea/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/unitPlantArea/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitPlantArea/delete/' + obj.data.id,
                });
            });
        }
        /**
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitPlantArea/update'
                        });
                    });
                    // 触发表单按钮点击事件
