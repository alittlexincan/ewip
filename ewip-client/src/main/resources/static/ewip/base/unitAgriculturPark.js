...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/unitAgriculturPark/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitAgriculturPark/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/unitAgriculturPark/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitAgriculturPark/delete/' + obj.data.id,
                });
            });
        }
        /**
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitAgriculturPark/update'
                        });
                    });
                    // 触发表单按钮点击事件
