...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/facilitySupply/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
        ...
        ,cols: [[
            ...
            ,{field: 'address', title: '应急储备地址', sort: true}
    ...
    let active = {
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/facilitySupply/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/facilitySupply/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/facilitySupply/delete/' + obj.data.id,
                });
            });
        }
        /**
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/facilitySupply/update'
                        });
                    });
                    // 触发表单按钮点击事件
        ...
        ,'detailsOption': function (obj) {
            ...
            layer.open({
                type: 1
                ,title: "<i class='layui-icon'>&#xe642;</i>详情信息"
                ,area: '500px'
                ,shade: 0.3
                ,maxmin:true
                ,offset: '50px'
