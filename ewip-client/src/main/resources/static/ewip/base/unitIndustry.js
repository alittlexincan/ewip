...
layui.use(['table','form','laytpl','layer', 'selectTree'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/unitIndustry/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
        ...
        ,cols: [[
            ...
            ,{field: 'name', title: '工矿企业名称', sort: true}
            ,{field: 'address', title: '工矿企业地址', sort: true}
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitIndustry/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/unitIndustry/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitIndustry/delete/' + obj.data.id,
                });
            });
        }
        /**
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/unitIndustry/update'
                        });
                    });
                    // 触发表单按钮点击事件
