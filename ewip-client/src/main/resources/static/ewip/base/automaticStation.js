...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'laydate'], function(){
    ...
    let isCheckFormat = function(d){
        return d.isCheck == 1? '是' : '否';
    };
    /**
     * 加载表格
     */
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/automaticStation/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/automaticStation/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/automaticStation/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/automaticStation/delete/' + obj.data.id,
                });
            });
        }
        /**
            ...
            layer.open({
                ...
                ,success: function(layero,index){
                    ...
                    laytpl(updatePop.innerHTML).render(param, function(html){
                        ...
                        $("#updateDiv select[name='supplyModel']").val(param.supplyModel);
                        $("#updateDiv select[name='environment']").val(param.environment);
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/automaticStation/update'
                        });
                    });
                    // 触发表单按钮点击事件
    ...
    form.verify({
        name: function (value) {
            if(value.length == 0) return '请填写站名';
        }
        ,lon: function (value) {
