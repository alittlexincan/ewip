...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/facilityPublish/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
        ...
        ,cols: [[
            ...
            ,{field: 'code', title: '设备编号', sort: true}
            ,{field: 'factory', title: '设备厂家', sort: true}
            ,{field: 'type', title: '场所类型',sort: true}
            ,{field: 'address', title: '地址', sort: true}
            ,{field: 'equipmentUse', title: '设备用途', sort: true}
    ...
    let reloadTable = function (param) {
        table.reload('table', {
            ...
            where: { //设定异步数据接口的额外参数，任意设
                ...
                ,factory: param == undefined ? '' : param.factory
            }
        });
    };
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitAddBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/facilityPublish/insert'
                        });
                    });
                    // 触发表单按钮点击事件
                    $("#submitAddBtn").click();
        ...
        ,'deleteBarBtn': function(){
            ...
            layer.confirm('确定删除这批数据？', function(index){
                ...
                submitServer({
                    ...
                    ,url: '/client/facilityPublish/delete'
                });
            });
        }
        /**
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/facilityPublish/delete/' + obj.data.id,
                });
            });
        }
        /**
                ...
                ,yes: function(index, layero){
                    ...
                    form.on("submit(submitUpdateBtn)", function(data){
                        ...
                        submitServer({
                            ...
                            ,type: 'POST'
                            ,param: data.field
                            ,url: '/client/facilityPublish/update'
                        });
                    });
                    // 触发表单按钮点击事件
