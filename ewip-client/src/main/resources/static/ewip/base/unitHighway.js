...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/unitHighway/delete/' + obj.data.id,
                });
            });
        }
        /**
    ...
    form.verify({
        ...
        ,code: function (value) {
            if(value.length == 0)  return '请填写编号';
        }
    });
