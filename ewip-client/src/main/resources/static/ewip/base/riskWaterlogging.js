...
layui.use(['table','form','laytpl','layer', 'selectTree', 'zTree', 'disaster'], function(){
    ...
    table.render({
        id: 'table'
        ,elem: '#table'
        ,url:'/client/riskWaterlogging/select'
        ,even: true
        ,page:true
        ,height: 'full-165'
        ...
        ,cols: [[
            ...
            ,{field: 'area', title: '最大淹没面积'}
            ,{field: 'prec1', title: '过去1小时雨量'}
            ,{field: 'prec2', title: '过去2小时雨量'}
            ,{field: 'prec3', title: '过去3小时雨量'}
            ,{field: 'prec6', title: '过去6小时雨量'}
            ,{field: 'prec12', title: '过去12小时雨量'}
