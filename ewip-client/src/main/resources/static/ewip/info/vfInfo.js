...
layui.use(['table','form','laytpl','layer', 'ajaxFileUpload'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'areaCode', title: '行政区编码', sort: true}
            ,{field: 'vulnerFloodName', title: '易涝点名称',sort: true}
    ...
    let active = {
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/vfInfo/delete/' + obj.data.id,
                });
            });
        }
        /**
         ...
         */
        ,'downModel': function () {
            window.location.href="/client/vfInfo/downModel";
        }
        /**
         * 开始导入数据
         */
     ...
     */
    form.verify({
        vulnerFloodName: function (value) {
    ...
    let reloadTable = function (param) {
        table.reload('table', {
            ...
            where: { //设定异步数据接口的额外参数，任意设
                areaCode: param == undefined ? '' : param.areaCode
                ,vulnerFloodName: param == undefined ? '' : param.vulnerFloodName
            }
        });
    };
    /**
