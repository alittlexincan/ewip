...
layui.use(['table','form','laytpl','layer', 'ajaxFileUpload'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'basinCode', title: '中小河流代码', sort: true}
            ,{field: 'basinName', title: '中小河流名称',sort: true}
    ...
    let active = {
        ...
        ,'deleteOption': function (obj) {
            layer.confirm('确定删除该数据？', function(index){
                ...
                submitServer({
                    ...
                    ,param: null
                    ,type: 'DELETE'
                    ,url: '/client/biInfo/delete/' + obj.data.id,
                });
            });
        }
        /**
         ...
         */
        ,'downModel': function () {
            window.location.href="/client/biInfo/downModel";
        }
        /**
         * 开始导入数据
         */
    ...
    let reloadTable = function (param) {
        table.reload('table', {
            ...
            where: { //设定异步数据接口的额外参数，任意设
                basinCode: param == undefined ? '' : param.basinCode
                ,basinName: param == undefined ? '' : param.basinName
            }
        });
    };
    /**
