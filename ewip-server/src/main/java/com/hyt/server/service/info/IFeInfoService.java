 ...
 * @Modified By:
 */
public interface IFeInfoService extends IBaseService<FeInfo>{

        PageInfo<FeInfo> selectAll(Map<String, Object> map);

        List<FeInfo> selectList(Map<String, Object> map);
