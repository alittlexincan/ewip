 ...
 * @Modified By:
 */
public interface IMfrInfoService extends IBaseService<MfrInfo>{

        PageInfo<MfrInfo> selectAll(Map<String, Object> map);

        List<MfrInfo> selectList(Map<String, Object> map);
